...
- **Server investigation rule**: When investigating errors via SSH, the moment you see a clear root cause (e.g. "Cannot find module", "file not found", missing credentials, permission denied, missing env var), STOP reading more logs immediately. State the root cause finding, then execute the fix. Never expand log line ranges after identifying the error — reading more of the same log is not progress, it is an investigation loop.
