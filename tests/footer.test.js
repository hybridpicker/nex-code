...
describe('StickyFooter', () => {
  ...
  describe('setStatusInfo()', () => {
    it('sets model, branch, and project', () => {
      footer.setStatusInfo({ model: 'gpt-4', branch: 'main', project: 'my-app' });
  ...
  describe('_statusLine() extended', () => {
    it('includes all three parts with dividers when all set', () => {
      footer.setStatusInfo({ model: 'claude', branch: 'devel', project: 'nex' });
      const line = footer._statusLine();
  ...
  describe('activate() on TTY', () => {
    let origIsTTY, origRows, origCols, origWrite, origStderrWrite, origLog, origError;
