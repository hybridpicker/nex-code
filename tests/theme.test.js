...
describe('theme.js', () => {
  ...
  describe('DARK theme keys', () => {
    ...
    it('has all tool category keys', () => {
      const { DARK } = require('../cli/theme');
      const toolKeys = [
        'tool_read', 'tool_write', 'tool_exec', 'tool_search',
        'tool_git', 'tool_web', 'tool_sysadmin', 'tool_default',
      ];
    ...
    it('has syntax highlighting keys', () => {
      const { DARK } = require('../cli/theme');
      const synKeys = ['syn_keyword', 'syn_string', 'syn_number', 'syn_comment', 'syn_key'];
    ...
    it('has banner keys', () => {
      const { DARK } = require('../cli/theme');
      const bannerKeys = ['banner_logo', 'banner_name', 'banner_version', 'banner_model', 'banner_yolo'];
    ...
    it('has footer keys', () => {
      const { DARK } = require('../cli/theme');
      const footerKeys = ['footer_sep', 'footer_model', 'footer_branch', 'footer_project', 'footer_divider'];
    ...
    it('has backward-compat ANSI keys', () => {
      const { DARK } = require('../cli/theme');
      const compatKeys = ['white', 'red', 'green', 'yellow', 'blue', 'magenta', 'cyan', 'gray', 'bgRed', 'bgGreen', 'brightCyan', 'brightMagenta', 'brightBlue'];
