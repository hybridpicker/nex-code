        ...
        parameters: {
          ...
          properties: {
            ...
            project_path: {
              type: "string",
              description:
                "Working directory on the remote server (e.g. /home/jarvis/remote-service). Defaults to home directory.",
            },
            model: {
              type: "string",
              description:
        ...
        if (we && fe < 3) {
          for (let T of Ne)
            if (
              ...
              (console.log(
                `${y.yellow}  \u26A0 Jarvis-local guard: blocking local ${T.fnName} \u2014 use ssh_exec on 203.0.113.10${y.reset}`,
              ),
                (T.canExecute = !1),
                (T.errorResult = {
                  role: "tool",
                  content: `BLOCKED: ${T.fnName} denied \u2014 this is a server issue. Use ssh_exec on 203.0.113.10 instead.`,
                  tool_call_id: T.callId,
                }));
              break;
            }
