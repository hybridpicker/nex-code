...
A comprehensive benchmark suite that tests nex-code on **35 real-world tasks** across 7 categories, sourced from actual projects (cookbook, sample-react-app, chord-library, remote-service, practice-wizard, AlmaLinux9 server docs):
